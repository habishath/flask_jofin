...
from jofin import db, bcrypt
from jofin.forms import User_Login, Employer_Signup, Employer_User_Update, Job_Add, Job_Update, Forgot_Password, Reset_Password, Company_Search
from jofin.models import User, Employer, Job, jobs_applied, Applicant
from jofin.utils import save_file, user_role_required, remove_file, send_pwd_reset_email, send_shortlist_email
...
def profile(company_id):
    ...
    return render_template("employers/profile.html", title="JoFin | Company Profile", company=company)
...
def company_list():
    ...
    return render_template("employers/list.html", title="JoFin | Companies", companies=companies, head=head, form1=form1)
...
def job_details(job_id):
    ...
    return render_template("employers/job-details.html", title="JoFin | Job Details", job=job, applicants=applicants)
